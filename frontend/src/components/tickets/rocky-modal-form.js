...
class RockyForm extends Component {
    constructor(props) {
        super(props);
    ...
    calculatePrice() {
        ...
        if (this.state.age === "adult" && this.state.nrOfDays < 4) {
            ...
            if (this.state.nrOfDays === 1) {
                ...
                this.state.price = 102;
            }
            else if (this.state.nrOfDays === 3) {
                this.state.price = 154;
            }
        }
    ...
    handleSubmission(e) {
        ...
        if (this.state.riderPass.approvedForTrack === "The Rocky" || this.state.riderPass.approvedForTrack === "All Tracks" && this.state.age !== "" && this.state.nrOfDays !== "" && this.state.price !== 0 && this.state.date !== "") {
        ...
        else if (this.state.riderPass.approvedForTrack !== "The Rocky" || this.state.riderPass.approvedForTrack !== "All Tracks") {
